...
class GeometriesTests {
	...
	void testfindIntsersections() {
		...
		List<Point> intersections = geometriesSomeIntersections.findIntsersections(ray);
		...
		assertNull(emptyGeometries.findIntsersections(ray0), "BVA: Empty collection");
		...
		List<Point> intersections1 = geometriesNoIntersections.findIntsersections(ray2);
		...
		List<Point> intersections2 = geometriesAllIntersections.findIntsersections(ray3);
