...
class TriangleTests {
	...
	void findIntersections() {
		...
		List<Point> resultEdge = triangle.findIntersections(rayEdge);
		...
		List<Point> resultVertex = triangle.findIntersections(rayVertex);
		...
		List<Point> resultOutside = triangle.findIntersections(rayOutside);
		...
		List<Point> resultParallel = triangle.findIntersections(rayParallel);
		...
		List<Point> resultOrthogonal = triangle.findIntersections(rayOrthogonal);
