...
class PlaneTests {
	...
	void testPlaneConstructor() {
		...
		// Ensure an IllegalArgumentException is thrown when constructing a plane with
		// two identical points
		IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
				() -> new Plane(point1, point2, point3));
		// Check if the exception message is correct
		assertEquals("Constructing a plane with two identical points should throw an exception",
		...
		// Check if the exception message is correct
		assertEquals("Constructing a plane with three collinear points should throw an exception",
				exception.getMessage());
	}
	...
	void testGetNormal() {
		...
		// Ensure the dot product is close to 0
		assertTrue(Math.abs(dotProduct) < 0.000000001, "Normal vector is not perpendicular to the plane");
	 ...
	 * 
	 * <p>
	 * This test method verifies the behavior of the {@link Plane#getNormal(Point)}
	 * method by checking the following conditions:
	 * </p>
	 * 
	 * <ul>
