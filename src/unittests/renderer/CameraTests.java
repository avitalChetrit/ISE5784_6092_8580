...
class CameraTest {
	...
	void testConstructRay() {
		...
		assertEquals(new Ray(Point.ZERO, new Vector(0, 0, -1)), camera1.constructRay(4, 4, 1, 1), badRay);

		// =============== Boundary Values Tests ==================
		// BV01: 4X4 Corner (0,0)
		assertEquals(new Ray(Point.ZERO, new Vector(0.2, -0.2, -1)), camera1.constructRay(4, 4, 0, 0), badRay);

		// BV02: 4X4 Side (0,1)
		assertEquals(new Ray(Point.ZERO, new Vector(0, -0.2, -1)), camera1.constructRay(4, 4, 1, 0), badRay);
