...
public class Sphere extends RadialGeometry {
	 ...
	 * @return A list of intersection points between the ray and the sphere, or an empty list if there are no intersections
	 */
	@Override
	public List<Point> findIntsersections(Ray ray) {
	    ...
	    // Calculate the distance from the ray's start point to the closest point to the sphere's center
	    double d = Math.sqrt(u.lengthSquared() - tm * tm);

	    // If the distance is greater than the sphere's radius, there are no intersections
	    if (d > getRadius()) {
