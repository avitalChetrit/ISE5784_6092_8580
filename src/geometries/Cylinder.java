...
public class Cylinder extends RadialGeometry {
	 ...
	 * If the point lies on the bottom cap of the cylinder, returns a
	 * downward-pointing normal vector. If the point lies on the top cap of the
	 * cylinder, returns an upward-pointing normal vector. Otherwise, returns a
	 * normal vector pointing in the direction of the radius of the cylinder at the
	 * given point.
	 *
	...
	public Vector getNormal(Point point) {
		...
		Vector vectorToPoint = point.subtract(new Point(0, 0, 0)); // Assuming the center of the cylinder is at (0, 0,
																	// 0)

		// Calculate the height of the point from the center of the cylinder
		double pointHeight = vectorToPoint.dotProduct(new Vector(0, 1, 0)); // Assuming the cylinder is aligned with the
																			// y-axis

		// Calculate the projection of the vector from the center to the point onto the
		// xy-plane
