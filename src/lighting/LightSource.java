 ...
 * A light source has properties to determine its intensity and direction.
 */
public interface LightSource {
    ...
    /**
     * Returns the direction vector from the light source to a given point in the scene.
     * This vector represents the direction in which the light is shining.
     *
     * @param p The point in the scene.
