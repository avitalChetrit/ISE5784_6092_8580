...
public class Double3 {
	 ...
	 * @return {@code true} if all components (d1, d2, d3) are greater than {@code minCalcColorK}, otherwise {@code false}.
	 */
	public boolean greaterThan(double minCalcColorK) {
	    return d1 > minCalcColorK && d2 > minCalcColorK && d3 > minCalcColorK;
	}
	/**
	 * Checks if all components are greater than the corresponding components of another Double3 object.
	 * 
	 * @param other The Double3 object to compare against.
	 * @return {@code true} if all components (d1, d2, d3) are greater than the corresponding components of {@code other}, otherwise {@code false}.
	 */
